...
export default function handleMessagePaginataion({ roomId, setMessages }: {
   roomId: string, setMessages: Dispatch<SetStateAction<MessageMerged[]>>
}) {
   ...
   useEffect(() => {
      const handleScroll = () => {
         if (window.pageYOffset === 0 && !mutation.isPending) { // TODO add threshold
